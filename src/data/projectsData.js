export const PROJECTS_DATA = [
    {
        ...
        budget: "1.500.000 TL",
        summary: "Diffüzyon MR görüntüleri üzerinden iskemik çekirdek ve penumbra hacimlerini saniyeler içinde hesaplayan yerli bir yapay zeka yazılımı geliştirilmesi.",
    ...
    {
        id: 2,
        title: "Alzheimer Hastalığında Erken Tanı İçin Yeni MR Biyobelirteçleri",
        status: "Tamamlandı",
        area: "İleri MR Görüntüleme",
        year: "2022",
        duration: "2022 - 2024",
        funding: "BAP (Bilimsel Araştırma Projeleri)",
        budget: "450.000 TL",
        summary: "Glimfatik sistem aktivitesini görüntüleyen yeni bir MR sekansı kullanılarak, Alzheimer hastalığının klinik belirtiler vermeden önceki evresinin tespiti.",
    ...
    {
        id: 3,
        title: "Serebral Anevrizma Tedavisinde Yeni Nesil Akım Çevirici Stentler",
        status: "Devam Ediyor",
        area: "Girişimsel Nöroradyoloji",
        year: "2023",
        duration: "2023 - 2025",
        funding: "TÜBİTAK 1501",
        budget: "2.200.000 TL",
        summary: "Daha esnek ve endotelizasyonu hızlandıran nano-kaplamalı yeni nesil akım çevirici stentlerin hayvan modellerinde denenmesi.",
