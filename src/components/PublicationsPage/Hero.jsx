...
export default function Hero() {
    ...
    return (
        <div className="bg-[#1c2b4a] rounded-2xl p-8 text-white shadow-xl flex flex-col md:flex-row justify-between items-center gap-8">
            <div>
                <h1 className="text-3xl md:text-4xl font-bold mb-3 text-center lg:text-left">Bilimsel Yayınlarımız</h1>
                <p className="text-gray-300 max-w-2xl text-lg text-center lg:text-left">
